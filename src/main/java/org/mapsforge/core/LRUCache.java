...
/**
 * An LRUCache with a fixed size and an access-order policy. Old mappings are automatically removed from the
 * cache when new mappings are added. This implementation uses an {@link LinkedHashMap} internally.
 * 
 * @param <K>
